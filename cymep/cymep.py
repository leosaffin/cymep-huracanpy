...
for ii in range(len(files)):
    ...
    data_formatting = ["%d", "%d", "%d", "%d"] + ["%.2f"] * (
        filtered_storm_data.shape[1] - 4
    )
    ...
    np.savetxt(
        "./csv-files/storms_"
        + os.path.splitext(csvfilename)[0]
        + "_"
        + strbasin
        + "_"
        + strs[ii]
...
write_single_csv(
    ...
    strs,
    "./csv-files/",
    "metrics_" + os.path.splitext(csvfilename)[0] + "_" + strbasin + "_climo_mean.csv",
)
write_single_csv(
    asdict,
    strs,
    "./csv-files/",
    "metrics_" + os.path.splitext(csvfilename)[0] + "_" + strbasin + "_storm_mean.csv",
)
write_single_csv(
    stdydict,
    strs[0],
    "./csv-files/",
    "means_" + os.path.splitext(csvfilename)[0] + "_" + strbasin + "_climo_mean.csv",
)
